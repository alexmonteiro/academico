...
class MatricesControllerTest < ActionController::TestCase
  ...
  test "should create matrix" do
    assert_difference('Matrix.count') do
      post :create, :matrix => { :ended_at => @matrix.ended_at, :maxdisciplines => @matrix.maxdisciplines, :maxseasons => @matrix.maxseasons, :started_at => @matrix.started_at }
    end
  ...
  test "should update matrix" do
    put :update, :id => @matrix, :matrix => { :ended_at => @matrix.ended_at, :maxdisciplines => @matrix.maxdisciplines, :maxseasons => @matrix.maxseasons, :started_at => @matrix.started_at }
    assert_redirected_to matrix_path(assigns(:matrix))
  end

module ApplicationHelper
  ...
  def menu_config
    ...
    array_controllers = [['countries','Países / Estados / Cidades','Gerais'], 
                         ...
                         ['registration_statuses','Situação da Matrícula','Itens de Institucional'],
                         ['class_times','Horários','Itens de Institucional'],
                         ...
                         ['class_student_statuses','Estados do Estudante','Institucional'],
                         ['registration_class_statuses','Situação Curricular','Itens de Institucional'],
                         ['class_record_types','Tipos de Aula','Itens de Institucional'],
                         ['discipline_class_exam_types','Tipos de Avaliação','Itens de Institucional'],

module ApplicationHelper
  ...
  def menu_config
    ...
    array_controllers = [['countries','Países / Estados / Cidades','Gerais'], 
                         ...
                         ['registration_class_statuses','Estados de Registro','Itens de Institucional'],
                         ['class_record_types','Tipos de Registro de Componente Curricular','Itens de Institucional'],
                         ['discipline_class_exam_types','Tipos de Exame de Componente Curricular por Disciplina','Itens de Institucional'],

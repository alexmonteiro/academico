...
class Registration < ActiveRecord::Base
  ...
  attr_accessible :registration_number, :course_matrix_id, :registration_at, :registration_status_id, :person_id, :admission_type_ids, :ways_of_admission_id,
                  ...
                  :responsible_complete_name, :responsible_cpf, :responsible_kinship, :responsible_address, :responsible_cep, :responsible_have_work, :responsible_occupation, :responsible_workplace, :responsible_workphone, :responsible_telephone, :responsible_schooling, :responsible_email,
